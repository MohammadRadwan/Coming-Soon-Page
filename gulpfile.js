...
gulp.task('js-vendors', function () {
    return gulp.src([
        ...
        'src/scripts/vendors/particles.min.js',
        'src/scripts/vendors/particles_2.js',
        'src/scripts/vendors/TimeCircles.js',
        ])
        .pipe(plumber({ errorHandler: function(err) {
            notify.onError({
                title: "Gulp error in " + err.plugin,
...
gulp.task('watch', function () {
    gulp.watch('src/favicon.jpg', ['logo']);
